...
const _resource = 'bibrefcitations';  // impt: lowercase, because used in URI
const _resourceId = 'bibRefCitationId';
const _select = {
    none: {
        stats: [
        ...
        register: function(server, options) {
            ...
            server.route([{ 
                ...
                config: {
                    ...
                    tags: ['treatments', 'bibliographic reference citations', 'api'],
                    plugins: {
                        'hapi-swagger': {
                            order: 6,
